...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-lu6bw4.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-lu6bw4.containers.anotherwebservice.com/
...
```
git clone git@github.com:kalmakazi/container-lu6bw4.git
cd container-lu6bw4
```
...
```
docker attach container-lu6bw4
```
